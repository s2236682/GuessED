...
query="SELECT * from s1737656.polygons_game a, s1737656.searchpol_game b where sdo_relate(a.ora_geometry, b.ora_geometry, 'mask=anyinteract querytype=window') = 'TRUE' and b.spol_lvl = '7' and a.poly_id = '16'"
...
for row in c:
    if row[4] == '%s' %searchterm:
        ...
        print('<center><br><br><button type=\"button" class=\"btn btn-info btn-lg\"><a href=\"https://www.geos.ed.ac.uk/~s2236682/asdm/L3Q4.html\">NEXT QUESTION</a></button></center>')
    else:
        ...
        print('<center><br><br><button type=\"button" class=\"btn btn-info btn-lg\"><a href=\"https://www.geos.ed.ac.uk/~s2236682/asdm/L3Q3.html\">Back</a></button></center>')
