...
query="SELECT * FROM s1737656.POINTS_GAME A, s1737656.SEARCHPOINTS_GAME B WHERE SDO_NN(A.ORA_GEOMETRY, B.ORA_GEOMETRY, 'sdo_num_res=1') = 'TRUE' AND B.SP_NAME = 'E' AND B.SP_LVL = '2'"
...
for row in c:
    if row[3] == '%s' %searchterm:
        ...
        print('<center><br><br><button type=\"button" class=\"btn btn-info btn-lg\"><a href=\"https://www.geos.ed.ac.uk/~s2236682/asdm/L2Q3.html\">NEXT QUESTION</a></button></center>')
    else:
        ...
        print('<center><br><br><button type=\"button" class=\"btn btn-info btn-lg\"><a href=\"https://www.geos.ed.ac.uk/~s2236682/asdm/L2Q2.html\">Back</a></button></center>')
