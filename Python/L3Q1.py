...
query="SELECT * FROM s1737656.SEARCHPOINTS_GAME A, s1737656.POLYGONS_GAME B WHERE SDO_NN(B.ORA_GEOMETRY, A.ORA_GEOMETRY, 'sdo_num_res=1') = 'TRUE' AND A.SP_ID = '8'"
...
for row in c:
    if row[9] == '%s' %searchterm:
        ...
        print('<center><br><br><button type=\"button" class=\"btn btn-info btn-lg\"><a href=\"https://www.geos.ed.ac.uk/~s2236682/asdm/L3Q2.html\">NEXT QUESTION</a></button></center>')
    else:
        ...
        print('<center><br><br><button type=\"button" class=\"btn btn-info btn-lg\"><a href=\"https://www.geos.ed.ac.uk/~s2236682/asdm/L3Q1.html\">Back</a></button></center>')
