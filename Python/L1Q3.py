...
query="SELECT * FROM s1737656.POLYGONS_GAME A, s1737656.SEARCHPOINTS_GAME B WHERE SDO_NN(A.ORA_GEOMETRY, B.ORA_GEOMETRY, 'sdo_num_res=1') = 'TRUE' AND B.SP_NAME = 'C' AND B.SP_LVL = '1'"
...
for row in c:
    if row[4] == '%s' %searchterm:
        ...
        print('<center><br><h2>Congratulations! You completed Level 1!</h2></center>')
        print('<center><br><br><button type=\"button" class=\"btn btn-info btn-lg\"><a href=\"https://www.geos.ed.ac.uk/~s2236682/asdm/L2Q1.html\">GO TO LEVEL 2</a></button></center>')
    else:
        ...
        print('<center><br><br><button type=\"button" class=\"btn btn-info btn-lg\"><a href=\"https://www.geos.ed.ac.uk/~s2236682/asdm/L1Q3.html\">Back</a></button></center>')
