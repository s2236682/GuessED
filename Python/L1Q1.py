...
query="SELECT * FROM s1737656.POLYGONS_GAME A, s1737656.SEARCHPOINTS_GAME B WHERE SDO_NN(A.ORA_GEOMETRY, B.ORA_GEOMETRY, 'sdo_num_res=1') = 'TRUE' AND B.SP_NAME = 'A' AND B.SP_LVL = '1'"
...
for row in c:
    if row[4] == '%s' %searchterm:
        ...
        print('<center><br><br><button type=\"button" class=\"btn btn-info btn-lg\"><a href=\"https://www.geos.ed.ac.uk/~s2236682/asdm/L1Q2.html\">NEXT QUESTION</a></button></center>')
    else:
        ...
        print('<center><br><br><button type=\"button" class=\"btn btn-info btn-lg\"><a href=\"https://www.geos.ed.ac.uk/~s2236682/asdm/L1Q1.html\">Back</a></button></center>')
