...
mapp = folium.Map(location=[55.945331,-3.188945], zoom_start=17, tiles='cartodbdark_matter')
...
c.execute("SELECT A.SP_NAME, SDO_UTIL.TO_WKTGEOMETRY(A.ORA_GEOMETRY), SDO_UTIL.TO_WKTGEOMETRY(B.ORA_GEOMETRY) FROM SEARCHPOINTS_GAME A, POLYGONS_GAME B  WHERE A.SP_NAME = 'I' AND B.POLY_NAME IN ('Teviot Row House', 'McEwan Hall', 'Psychology building', 'Hugh Robson')")
