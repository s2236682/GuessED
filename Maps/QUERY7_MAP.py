...
mapp = folium.Map(location=[55.943487,-3.188730], zoom_start=17, tiles='cartodbdark_matter')
...
c.execute("SELECT A.SP_NAME, SDO_UTIL.TO_WKTGEOMETRY(A.ORA_GEOMETRY), SDO_UTIL.TO_WKTGEOMETRY(B.ORA_GEOMETRY) FROM SEARCHPOINTS_GAME A, POLYGONS_GAME B  WHERE A.SP_NAME = 'H' AND B.POLY_NAME IN ('Main Library', 'Chrystal Macmillan', 'Hugh Robson', 'Appleton Tower', 'Psychology building')")
