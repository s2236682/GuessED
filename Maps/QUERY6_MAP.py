...
mapp = folium.Map(location=[55.950393,-3.203706], max_zoom=20, zoom_start=18, tiles='cartodbdark_matter')
...
c.execute("SELECT A.SP_NAME, SDO_UTIL.TO_WKTGEOMETRY(A.ORA_GEOMETRY), SDO_UTIL.TO_WKTGEOMETRY(B.ORA_GEOMETRY), C.ROUTE_NAME, SDO_UTIL.TO_WKTGEOMETRY(C.ORA_GEOMETRY) FROM SEARCHPOINTS_GAME A, POINTS_GAME B, ROUTES_GAME C WHERE A.SP_NAME = 'F' AND C.ROUTE_NAME = 'Princes Street'")
